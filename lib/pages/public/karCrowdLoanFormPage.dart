...
class _KarCrowdLoanFormPageState extends State<KarCrowdLoanFormPage> {
  ...
  Widget build(_) {
    return GetBuilder(
        init: widget.service.plugin.balances,
        builder: (_) {
          final dic = I18n.of(context).getDic(i18n_full_dic_app, 'public');
          final decimals =
              (widget.service.plugin.networkState.tokenDecimals ?? [12])[0];
          ...
          final karInfoStyle = TextStyle(
              color: karColor, fontSize: 20, fontWeight: FontWeight.bold);
          ...
          final inputValid =
              _amountValid && (_referralValid || _referral.isEmpty);
                ...
                Container(
                  ...
                  child: CupertinoTextField(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color:
                              _amountFocusNode.hasFocus ? karColor : grayColor),
                    ),
